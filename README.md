...
- [**Voicely Role**](https://github.com/Erallie/voicely-role): A Discord bot that pings a role when there are a certain number of people in a voice channel.
## Minecraft Stuff
...
- [**Modrinth Sync**](https://github.com/Erallie/modrinth-sync): A set of workflows that allow your plugin releases to be automatically pushed to modrinth.
## Miscellaneous Stuff
